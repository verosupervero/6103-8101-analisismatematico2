...
\usepackage[top=2cm, bottom=1cm, inner=1cm, outer=1.5cm]{geometry} % Márgenes personalizados
...
\begin{thebibliography}{X}
	\bibitem{Baz} \textsc{Jerrold E. Marsden} y \textsc{Anthony J. Tromba}, \textit{Cálculo Vectorial}, tercera edición, Addison-Wesley Iberoamericana, 1991.
\end{thebibliography}

% Nombres de las personas que han colaborado en la creación del apunte
\colaborador{María Inés Parnisari}
\colaborador{Martín Menendez}
