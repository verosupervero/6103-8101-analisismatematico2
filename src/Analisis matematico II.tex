...
\begin{minipage}{0.3\textwidth}
	\begin{figure}[H]
		\begin{center}
			\centering
			\includegraphics[scale=0.3]{integrales_de_sup.png}
...
\begin{minipage}{0.3\textwidth}
	\begin{figure}[H]
		\centering
		\includegraphics[scale=0.24]{integral_de_superficie.png}
...
\begin{minipage}{0.28\textwidth}
	\begin{figure}[H]
		\centering
		\includegraphics[scale=0.4]{divergencia_0}
...
\begin{minipage}{0.2\textwidth}
	\begin{figure}[H]
		\includegraphics[scale=0.2]{stokes}
	\end{figure}
\end{minipage}
