...
% Título y autor(es):
\title{Resumen de Análisis Matemático II (61.03)}
...
\chead{}
\rhead{\rightmark}
\lfoot{Análisis Matemático II (61.03)}
\cfoot{}
...
\begin{center}
\Large{\underline{\textsc{Análsis Matemático II A (61.03)}}}
	...
	\section{Introducción al espacio $R^n$}
			...
			\begin{table}[H]
				\begin{tabular}{c|c|c}
					...
					\parbox{4cm}{\begin{center} 	$p\in R^2,\, p=(r,\theta)$ \\ 
										con $r\geq0,\theta\in[0,2\pi]$ \end{center}} \\
					\hline
					\includegraphics[scale=0.4]{cilindricas} & \includegraphics[scale=0.4]{esfericas} & \noindent \includegraphics[scale=0.4]{polares} \\
					\hline
		...
		\subsection{Secciones cónicas}
			...
			\begin{tabular}{c c c c}
				...
				\includegraphics[scale=0.3]{circulo} & \includegraphics[scale=0.35]{elipse} & \includegraphics[scale=0.35]{parabola} & \includegraphics[scale=0.4]{hiperbola}
			\end{tabular}
		...
		\subsection{Superficies cuádricas}
			...
			\begin{center}
					\begin{tabular}{c c c}
						...
						\parbox{5cm}{\begin{center}\includegraphics[scale=0.3]{cilindro_eliptico} \\
											$\left(\frac{x}{a}\right)^2+\left(\frac{y}{b}\right)^2=1$	\end{center}} &
						\parbox{5cm}{\begin{center}	\includegraphics[scale=0.3]{cilindro_parabolico} \\
											$x^2+2rz=0$\end{center}} &
						\parbox{5cm}{\begin{center}	\includegraphics[scale=0.3]{cilindro_hiperbolico} \\
											$\left(\frac{x}{a}\right)^2-\left(\frac{y}{b}\right)^2=1$\end{center}} \\
				...
				\begin{center}
					\begin{tabular}{c | c c}
						...
						\parbox{5cm}{\begin{center}\includegraphics[scale=0.3]{cono}\\
											$\left(\frac{x}{a}\right)^2+\left(\frac{y}{b}\right)^2-\left(\frac{z}{c}\right)^2=0$\end{center}} &
						\parbox{5cm}{\begin{center}	\includegraphics[scale=0.3]{hiperboloide_1hoja} \\
											$\left(\frac{x}{a}\right)^2+\left(\frac{y}{b}\right)^2-\left(\frac{z}{c}\right)^2=1$\end{center}} &
						\parbox{5cm}{\begin{center}	\includegraphics[scale=0.3]{hiperboloide_2hojas} \\
											$\left(\frac{x}{a}\right)^2-\left(\frac{y}{b}\right)^2-\left(\frac{z}{c}\right)^2=1$\end{center}} \\
				...
				\begin{center}
					\begin{tabular}{c | c c}
						...
						\parbox{5cm}{\begin{center}\includegraphics[scale=0.3]{elipsoide}\\
											$\left(\frac{x}{a}\right)^2+\left(\frac{y}{b}\right)^2+\left(\frac{z}{c}\right)^2=1$\end{center}} &
						\parbox{5cm}{\begin{center}	\includegraphics[scale=0.3]{cono} \\
											$z=\left(\frac{x}{a}\right)^2+\left(\frac{y}{b}\right)^2$\end{center}} &
						\parbox{5cm}{\begin{center}	\includegraphics[scale=0.3]{paraboloide_hiperbolico} \\
											$z=\left(\frac{x}{a}\right)^2-\left(\frac{y}{b}\right)^2$\end{center}} \\
	...
	\section{Funciones de varias variables}
		\subsection{Funciones de varias variables}
			...
			\subsubsection{Puntos y conjuntos de puntos en $R^n$}
				...
				\begin{figure}[H]
					\subfloat[Convexidad]{\includegraphics[scale=0.5]{convexidad}} \hfill{}
					\subfloat[A es conexo, B no es conexo]{\includegraphics[scale=0.4]{conexidad}} \hfill{}
				...
				\subsubsection{Campo vectorial}
					...
					\begin{minipage}{0.6\textwidth}		
						Para graficar, hay que cortar la superficie $z=f(x,y)$ con los planos del tipo $y=kx$ y estudiar el tipo de curvas resultantes. En particular, se estudian las curvas resultantes de cortar la superficie con los planos $y=0$ y $x=0$.\\
						...
						Cuando $n=2$, la curva se llama \textit{\textbf{curva de nivel}}. Cuando $n=3$, la curva se llama \textit{\textbf{superficie de nivel}}. El nivel \textit{c}de la superficie $z=f\left(x,y\right)$ se puede interpretar geométricamente como la intersección de la función con el plano $z=c$. Estas curvas nos dan idea de la imagen de la función.
					...
					\node [definicion] (box){%
					    \begin{minipage}{0.80\textwidth}
					   		Sea $x_0\in R^n$ y $r>0.$ La bola abierta de centro $x_0$ y radio $r$, denotada por $B\left(x_0,r\right)$ es el conjunto de puntos de $R^n$ que distan de $x_0$ en menos que $r.$
					    \end{minipage}
					};
					...
					\node [definicion] (box){%
					    \begin{minipage}{0.80\textwidth}
					    	Un conjunto $U\subseteq R^n$ es un conjunto abierto de $R^n$ si para cada $x_0\in U$ existe un $r>0$ tal que $B\left(x_0,r\right)\subset U.$ Esto es, el conjunto $U\subseteq R^n$ será abierto si cuando tomamos un punto $x_0$ en él, este siempre tiene vecinos que siguen viviendo dentro de $U$.\\
					    \end{minipage}
					};
					...
					\node [definicion] (box){%
					    \begin{minipage}{0.80\textwidth}
					    	Sea $U\subseteq R^n$ un subconjunto de $R^n$. Un punto $x_0\in R^n$ es un punto frontera de U si toda bola abierta $B(x_0,r)$ contiene puntos en U y fuera de él.
					    \end{minipage}
					};
					...
					\node [definicion] (box){%
					    \begin{minipage}{0.80\textwidth}
					    	Sea $f:U\subseteq R^n \rightarrow R$ una función definida en el conjunto abierto U. Si $x_0$ es un punto de U o un punto frontera de U, se dice que el límite de $f$ cuando $x$ tiende a $x_0$ es L, lo cual se escribe como $\lim_{x\rightarrow x_0}f\left(x\right)=L$ si dado cualquier $\varepsilon>0$ existe $\delta>0$ tal que $x\in B\left(x_{0},\delta\right)\cap U\left(x\neq x_{0}\right)\Rightarrow f\left(x\right)\in B(L,\varepsilon)$
					    \end{minipage}
					};
					...
					\node [teorema] (box){%
					    \begin{minipage}{0.80\textwidth}
					    	Sean $f,g:U\subseteq R^n \rightarrow R$ dos funciones definidas en el abierto U y sea $x_0$ un punto de U o un punto frontera de U. Si $\lim_{x\rightarrow x_0}f\left(x\right)=L$ y $\lim_{x\rightarrow x_0}g\left(x\right)=M$, entonces:
					    	\begin{align}
					...
					\node [definicion] (box){%
					    \begin{minipage}{0.80\textwidth}
					    	Sea $f:U\subseteq R^n\rightarrow R$ una función definida en el abierto U de $R^n$, y sea $x_0\in U.$ Se dice que $f$ es una función continua en $x_{0}$ si $f\left(x_{0}\right)=\lim_{x\rightarrow x_0}f(x)$. Las funciones polinomiales son continuas en cualquier punto $\left(x_0,y_0\right)\in R^2$\\
					    \end{minipage}
					};
					...
					\node [definicion] (box){%
					    \begin{minipage}{0.80\textwidth}
					    	$f:U\subseteq R^n \rightarrow R$ una función definida en el abierto U de $R^n$, se dicecontinua en $U$ si lo es para todos y cada uno de los puntos $\left(x,y\right)\in U.$
					    \end{minipage}
					};
				...
				\subsection{Derivadas parciales}
					...
					\node [definicion] (box){%
					    \begin{minipage}{0.80\textwidth}
					        ...
					        \end{align}
					       Si $f^\prime (x_0)$ existe, su valor nos da la pendiente de la recta tangente a la gráfica de la función $y=f(x)$ en el punto $(x_0,y_0)$. Para este tipo de funciones, diferenciabilidad	equivale a existencia de derivada, y la diferenciabilidad en un punto implica la continuidad de la función en ese punto 
					    \end{minipage}
					};
					...
					\textit{Ejemplo}: sea la función $f(x,y)=5x^3+4xy+y^2$.	Se tiene que $f^\prime_x=15x^2+4y$ y que $f^\prime_y=4x+2y$.
			...
			\section{Funciones compuestas, inversas e implícitas}
				\subsection{Composición de funciones}
					...
					\node [definicion] (box){%
					    \begin{minipage}{0.80\textwidth}
					    	Si tenemos las funciones $g:I\subseteq R \rightarrow R$ y $f:J\subseteq R \rightarrow R$ (tales que $g(I)\subseteq J$),
					podemos formar la composición $f\circ g:I\subseteq R \rightarrow R$.\\
				...
				\subsection{Regla de la cadena: perspectiva general}
					...
					\frac{\partial f_{3}}{x}\left(0,0\right) & \frac{\partial f_{3}}{y}\left(0,0\right)\end{array}\right]=\left[\begin{array}{cc}
					cos\left(x+y\right) & cos\left(x+y\right)\\
					e^{x+y}\left(x+1\right) & xe^{x+y}\\
					1 & 1\end{array}\right]_{(0,0)}=\left[\begin{array}{cc}
					1 & 1\\
					1 & 0\\
					1 & 1\end{array}\right]$
				...
				\subsection{Funciones Implícitas (I)}
					...
					\node [teorema] (box){%
					    \begin{minipage}{0.80\textwidth}
							...
							\underbar{Nota 2}: Este teorema es \textit{local}. Nos asegura la existencia de la función $y=f(x)$, o nos asegura la posibilidad del despeje de $y$ en términos de $x$ a partir de $F(x,y)=0$ \textit{solamente en las cercanías del punto }$(x_0,y_0)$. Fuera de la vecindad $V$, el teorema no se responsabiliza por la existencia
					de la función $f$.								    	  		    	
   					    \end{minipage}
					};
					...
					\node [corolario] (box){%
					    \begin{minipage}{0.80\textwidth}
					    	 La ecuación de la recta tangente a la curva $F(x,y)=0$
					en $(x_{0},y_{0})$ está dada por
							\begin{align}
					...
					\node [corolario] (box){%
					    \begin{minipage}{0.80\textwidth}
					    	 La ecuación de la recta normal a la curva $F(x,y)=0$
					en $(x_{0},y_{0})$ está dada por
							\begin{align}
								\frac{\partial F}{\partial x}(x_0,y_0)(x-x_0)-\frac{\partial F}{\partial y}(x_0,y_0)(y-y_0)=0
							\end{align}	
				...
				\subsection{Definiciones y ejemplos preliminares}
					...
					\node [definicion] (box){%
					    \begin{minipage}{0.80\textwidth}
							...
							Una condición \textit{necesaria} (pero no suficiente) para que la función $f:U\subseteq R^n \to R$, diferenciable en $\overline{x}\in U$, tenga en ese punto un extremo local es que todas sus derivadas parciales se anulen en $\overline{x}$. Esto es necesario ya que si las derivadas parciales se anulan, el plano tangente
					en el punto es horizontal.
   					    \end{minipage}
					};
			...
			\begin{tikzpicture}
				\node [teorema] (box){%
				    \begin{minipage}{0.8\textwidth}
						...
						\end{align}
						En general, cuando en la región de integración se presentan anillos circulares, y/o cuando en la función a integrar aparezca de alguna forma las expresiones $\left(x^2+y^2\right),\frac{y}{x}$ puede resultar conveniente intentar el cálculo de la integral haciendo previamente el cambio a coordenadas polares: $\begin{cases} x=rcos(\theta)\\
			y=rsin(\theta)\end{cases}$. En este caso, el jacobiano de la transformación que aparece en la fórmula de cambio de variables es $\frac{\partial (x,y)}{\partial (r,\theta)}=r$.
